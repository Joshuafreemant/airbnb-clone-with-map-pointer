      ...
      <div className={classes.root}>
          ...
          <Carousel showThumbs={false} showStatus={false}>
            <div className="relative">
              <img
                src={props.image}
                alt=""
                className="object-cover rounded-t-2xl w-[310px] h-[200px]"
              />
            </div>
            <div>
              <img
        ...
        <div className="p-2 flex flex-col gap-[10px]">
          <div className="flex items-center justify-between">
            ...
            <p className=" mt-2 flex items-center text-[15px] text-sm">
              <FaStar /> &nbsp; {props.rating}
            </p>
          </div>
          ...
          <p className=" mb-8 text-[15px]">
            <span className="font-semibold">${props.cost_per_night}</span> night
          </p>
        </div>
      </div>
    )
